...
abstract class AppLocalizations {
  ...
  /// No description provided for @or_select_another_account.
  ///
  /// In en, this message translates to:
  /// **'Or select another account'**
  String get or_select_another_account;

  /// No description provided for @no_accounts_left.
  ///
  /// In en, this message translates to:
  /// **'No accounts left'**
  String get no_accounts_left;

  /// No description provided for @server_is_required.
  ///
  /// In en, this message translates to:
  /// **'Server Address is Required'**
  String get server_is_required;
  ...
  /// No description provided for @file_saved_in_downloads_folder.
  ///
  /// In en, this message translates to:
